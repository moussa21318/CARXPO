...
export type NotificationType = 'car_added' | 'car_updated' | 'car_deleted' | 'edit_requested' | 'edit_approved' | 'edit_rejected' | 'stage_changed' | 'car_confirmed' | 'delete_requested' | 'delete_approved' | 'delete_rejected' | 'customer_updated'
